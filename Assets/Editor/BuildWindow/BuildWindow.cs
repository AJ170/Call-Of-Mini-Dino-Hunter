...
public class BuildWindow : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        {
            StartBuild(BuildTarget.StandaloneWindows64, "CoM-Dino-Hunter");            // Change the project name here if your executable should be named differently
        }

        if (GUILayout.Button("Build Android APK"))
        {
            StartBuild(BuildTarget.Android, "CoM-Dino-Hunter");  // Change the project name here if you want a different APK file name
        }

        if (GUILayout.Button("Build iOS Xcode Project"))
        {
            StartBuild(BuildTarget.iOS, "CoM-Dino-Hunter");  // Change the project name here if you want a different Xcode file name
        }
    }
