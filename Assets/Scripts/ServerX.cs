...
#if UNITY_EDITOR
	public const string tnetConfigUrl = "https://example.com/tnet_dev-config-1.txt";
	public const string apiUrl = "https://dev.example.com/api/DinoHunter/";
#else
	public const string tnetConfigUrl = "https://example.com/tnet-config-1.txt";
