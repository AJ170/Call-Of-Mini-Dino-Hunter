...
public class iGameUIBase : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (move == Vector2.zero && wasMoving)
		{
			wasMoving = false;
			user.MoveStop();
		}
		else if (move != Vector2.zero)
		{
            ...
            user.MoveByCompass(move.x, move.y);
        }*/

        //if (Input.GetKeyDown(KeyCode.R)) Event_Move
	}
	...
	public void RegisterEvent_Windows()
	{
		...
		CControlWindows.bulletPurchase = Event_PurchaseBullet;
