...
public class CUseSkillRush : CUseSkill
{
	...
	public override kUseSkillStatus OnEnter(CCharBase charbase)
	{
        ...
        //if (Physics.Raycast(layerMask: ((!(cCharMob != null) || cCharMob.MobType != 1) && cCharMob.MobType != 10) ? (-1874853888) : (-1879048192), origin: charbase.Pos, direction: vector2, distance: magnitude + m_fExpandDis))
