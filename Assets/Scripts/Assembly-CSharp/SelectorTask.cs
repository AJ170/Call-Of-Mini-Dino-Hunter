...
public class SelectorTask : Task
{
	...
	public override kTreeRunStatus OnUpdate(Object inputParam, float deltaTime)
	{
		...
		kTreeRunStatus kTreeRunStatusVar;
		while (true)
		{
			kTreeRunStatusVar = m_curBehavior.Update(inputParam, deltaTime);
			if (kTreeRunStatusVar != kTreeRunStatus.Failture)
			{
				break;
			}
			m_nCurChild++;
